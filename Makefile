...
hooks-install:
	@set -eu; \
		...
		value_file=; values_file=; error_file=; markers_file=; references_file=; cleanup_preflight_temps() { rm -f "$$value_file" "$$values_file" "$$error_file" "$$markers_file" "$$references_file"; }; trap 'cleanup_preflight_temps; exit 129' HUP; trap 'cleanup_preflight_temps; exit 130' INT; trap 'cleanup_preflight_temps; exit 143' TERM; trap 'cleanup_preflight_temps' EXIT; \
