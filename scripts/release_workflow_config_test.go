...
func TestMakefileBenchGateRejectsNonAncestorRequestedBase(t *testing.T) {
	t.Parallel()
	...
	wantContains := []string{
		"Comparison status: invalid",
		"base benchmark input could not be read: requested base ref 'topic-base' is not an ancestor of HEAD.",
	}
	wantOmit := []string{
