...
const usage = `Usage:
  ...
  surfarea analyse <dependency> [--repo PATH] [--format table|json] [--language auto|js-ts] [--baseline PATH]
  surfarea analyse --top N [--repo PATH] [--format table|json] [--language auto|js-ts] [--baseline PATH] [--fail-on-increase PERCENT]
