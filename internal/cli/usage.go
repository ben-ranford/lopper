...
const usage = `Usage:
  ...
  lopper analyse <dependency> [--repo PATH] [--format table|json] [--language auto|all|js-ts|python|cpp|jvm|go|php|rust|dotnet] [--cache=true|false] [--cache-path PATH] [--cache-readonly] [--runtime-profile node-import|node-require|browser-import|browser-require] [--baseline PATH] [--runtime-trace PATH] [--runtime-test-command CMD] [--config PATH]
  lopper analyse --top N [--repo PATH] [--format table|json] [--language auto|all|js-ts|python|cpp|jvm|go|php|rust|dotnet] [--cache=true|false] [--cache-path PATH] [--cache-readonly] [--runtime-profile node-import|node-require|browser-import|browser-require] [--baseline PATH] [--runtime-trace PATH] [--runtime-test-command CMD] [--config PATH] [--fail-on-increase PERCENT]
