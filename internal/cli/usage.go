...
const usage = `Usage:
  lopper [tui]
  lopper tui [--repo PATH] [--language auto|all|js-ts|python|jvm|go|php|rust|dotnet|dart] [--top N] [--filter TEXT] [--sort name|waste] [--page-size N] [--snapshot PATH]
  lopper analyse <dependency> [--repo PATH] [--format table|json|sarif|pr-comment|cyclonedx-json|cyclonedx-xml|spdx-json|spdx-tv] [--language auto|all|js-ts|python|jvm|go|php|rust|dotnet|dart] [--baseline PATH] [--runtime-trace PATH] [--config PATH]
  lopper analyse --top N [--repo PATH] [--format table|json|sarif|pr-comment|cyclonedx-json|cyclonedx-xml|spdx-json|spdx-tv] [--language auto|all|js-ts|python|jvm|go|php|rust|dotnet|dart] [--baseline PATH] [--runtime-trace PATH] [--config PATH] [--fail-on-increase PERCENT]
