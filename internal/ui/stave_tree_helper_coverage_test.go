...
func TestStaveTreeHelperCoverageSnapshotModes(t *testing.T) {
	t.Run("snapshot tree includes help warning and summary focus", checkSnapshotTreeIncludesHelpWarningAndSummaryFocus)

	t.Run("snapshot tree folds filter text for ascii output", checkSnapshotTreeFoldsFilterTextForAsciiOutput)
}

func TestStaveTreeHelperCoverageInteractiveModes(t *testing.T) {
	t.Run("help mode shows feedback first on narrow viewports", checkHelpModeShowsFeedbackFirstOnNarrowViewports)

	t.Run("invalid detail focus falls back to summary selection and narrow warnings", checkInvalidDetailFocusFallsBackToSummarySelectionAndNarrowWarnings)

	t.Run("detail focus shows command feedback and truncates to viewport height", checkDetailFocusShowsCommandFeedbackAndTruncatesToViewportHeight)
}

func TestStaveTreeHelperCoverageFeedbackAndHelpModes(t *testing.T) {
	t.Run("feedback priority prefers confirm over status", checkFeedbackPriorityPrefersConfirmOverStatus)

	t.Run("feedback exposes command and status contracts", checkFeedbackExposesCommandAndStatusContracts)

	t.Run("help layouts switch by width", checkHelpLayoutsSwitchByWidth)
}
...
func TestStaveTreeHelperCoverageHelpers(t *testing.T) {
	checkStaveSeparatorsAndHints(t)
	checkStaveFeedbackAndSelection(t)
	checkStaveVisibleRowBounds(t)
	checkStaveDisplayEscaping(t)
}

func checkStaveSeparatorsAndHints(t *testing.T) {
	t.Helper()
...
func checkStaveFeedbackAndSelection(t *testing.T) {
	t.Helper()
...
func checkStaveVisibleRowBounds(t *testing.T) {
	t.Helper()
...
func checkStaveDisplayEscaping(t *testing.T) {
	t.Helper()
...
func TestStaveTreeHelperCoverageRendererModes(t *testing.T) {
	t.Run("env width and no color force ascii-safe renderer", checkEnvWidthAndNoColorForceAsciiSafeRenderer)

	t.Run("explicit color option keeps interactive renderer colored", checkExplicitColorOptionKeepsInteractiveRendererColored)
}

func TestStaveTreeHelperCoverageApplicationTreeRejectsDuplicateChildrenAtValidation(t *testing.T) {
	child, err := staveRecordNode(semantic.NodeKey{Kind: "dependency", Entity: "go/alpha", Slot: "main"}, "row", "alpha", "go • 50% used • 10 bytes waste", "status.success", nil)
	if err != nil {
...
func checkSnapshotTreeIncludesHelpWarningAndSummaryFocus(t *testing.T) {
	t.Helper()
...
func checkSnapshotTreeFoldsFilterTextForAsciiOutput(t *testing.T) {
	t.Helper()
...
func checkHelpModeShowsFeedbackFirstOnNarrowViewports(t *testing.T) {
	t.Helper()
	state := summaryState{page: 1, pageSize: 10}
...
func checkInvalidDetailFocusFallsBackToSummarySelectionAndNarrowWarnings(t *testing.T) {
	t.Helper()
...
func checkDetailFocusShowsCommandFeedbackAndTruncatesToViewportHeight(t *testing.T) {
	t.Helper()
	dep := summaryDependencyView{
		Language:             "go",
		Name:                 "alpha",
...
func checkFeedbackPriorityPrefersConfirmOverStatus(t *testing.T) {
	t.Helper()
...
func checkFeedbackExposesCommandAndStatusContracts(t *testing.T) {
	t.Helper()
...
func checkHelpLayoutsSwitchByWidth(t *testing.T) {
	t.Helper()
	cases := []struct {
		name       string
		width      int
...
func checkEnvWidthAndNoColorForceAsciiSafeRenderer(t *testing.T) {
	t.Helper()
...
func checkExplicitColorOptionKeepsInteractiveRendererColored(t *testing.T) {
	t.Helper()
