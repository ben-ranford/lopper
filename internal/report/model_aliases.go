...
type VulnerabilityDelta = model.VulnerabilityDelta
...
type VulnerabilityPolicy = model.VulnerabilityPolicy
type VulnerabilitySummary = model.VulnerabilitySummary
