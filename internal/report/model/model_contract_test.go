					...
					Suggestions: []CodemodSuggestion{
						{
							...
							Patch:             "@@",
							SafetyReasonCodes: []string{"deterministic-subpath-target"},
						},
					},
					Skips: []CodemodSkip{
						{Language: "js-ts", Dependency: "lodash", File: "src/skip.js", TargetFile: "src/skip.js", Line: 1, ImportName: "get", Module: "lodash", ReasonCode: "dynamic", Message: "dynamic import"},
					},
